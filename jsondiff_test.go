...
var cases = []struct {
	...
	{`{"a": [1,2,3]}`, `{"a": [3,2,1]}`, FullMatch},
	{`{"a": [{"a":[2, 3]},{"b":[2,3]}]}`, `{"a": [{"a":[2, 3]},{"b":[3,2]}]}`, FullMatch},
	{`{"a": [{"a":[2, 3]},{"b":[2,3]}]}`, `{"a": [{"a":[2, 3]},{"b":[3]}]}`, NoMatch},
	{`{"a": [{"a":[2, 3]},{"b":[2,3]}]}`, `{"a": [{"a":[3, 2]}]}`, SupersetMatch},
	{`[{"a":3, "b":5}]`, `[{"b":5, "a":3}]`, FullMatch},
}
